...
public class MySpace {
    ...
    public MySpace(String title, String start_date, String end_date, String start_time, String end_time, String repeat, String details, Boolean all_day, List<AlertModel> alerts, List<AlertModel> tags) {
        this.title = title;
